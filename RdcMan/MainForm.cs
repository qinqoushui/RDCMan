...
namespace RdcMan
{
    internal partial class MainForm : RdcBaseForm, IMainForm
    {
        ...
        public void AddToClientPanel(Control client)
        {
            ...
            client.MouseMove += (s, e) => LastMouseMoveTime = DateTime.Now;
        }
        ...
        private void InitComp()
        {
            ...
            ServerTree.Instance.MouseMove += (s, e) => LastMouseMoveTime = DateTime.Now;
            _clientPanel.MouseMove += (s, e) => LastMouseMoveTime = DateTime.Now;
            _remoteDesktopPanel.MouseMove += (s, e) => LastMouseMoveTime = DateTime.Now;
        }
        ...
        public Action FileClosed { get; set; }
